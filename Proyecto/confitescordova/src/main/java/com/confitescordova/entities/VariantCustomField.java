...
@Data
public class VariantCustomField {
    private UUID id; // Identificador único universal del campo personalizado
    private String name; // Nombre del campo personalizado (obligatorio)
    ...
    private String owner_resource = "product_variant"; // Propietario del campo personalizado (siempre "product_variant")
